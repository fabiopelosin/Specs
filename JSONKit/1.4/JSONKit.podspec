...
Pod::Spec.new do |s|
  ...
  #
  s.author    = { "johnezang" => "email@address.com" }
  # s.authors = { "johnezang" => "email@address.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author   = 'johnezang', 'other author'

  # Specify the location from where the source should be retreived.
  #
  s.source    = { :git => "https://github.com/johnezang/JSONKit.git", :tag => "v1.4" }
  # s.source   = { :svn => 'http://EXAMPLE/JSONKit/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/JSONKit', :revision => '1.0.0' }
  ...
  s.description = 'An optional longer description of JSONKit.'
